...
import 'package:sura_driver/customer_driver/customer_stat.dart';
...
class CustDashboard extends StatefulWidget {
  @override
  _CustDashboardState createState() => _CustDashboardState();
}
...
class _CustDashboardState extends State<CustDashboard> {
  ...
  Future<void> _fetchReportData() async {
    ...
    final url = Uri.parse(
        '${Url.url}/api/mobile/delivery/reportcustomer?merchant_id=$userId');
  ...
  Widget _buildCard({
    ...
    required int merchantId,          // 👈 pass userId here
  }) {
